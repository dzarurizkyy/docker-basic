...
Steps:
1. Run the login command with your Docker Hub username
2. When prompted for password, enter your Personal Access Token (not your account password)
3. For better security, use Personal Access Tokens instead of passwords
